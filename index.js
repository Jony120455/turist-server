...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.edhd9.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
app.get('/',(req,res)=> {
    res.send('This is tour world server')
})
